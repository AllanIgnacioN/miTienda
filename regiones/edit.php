...
if (isset($_GET["id"])) {
    ...
    if (isset($_POST["confirm"]) && $_POST["confirm"] == 1) {
        ...
        if (!$nombre) {
            $msg = "Debe ingresar nombre de la region";
        } else {
            //procedemos a actualizar el dato ingresado por el usuario en la tabla de regiones
            ...
            if ($row) {
                $_SESSION["success"] = "La region se ha modificado correctamente";
        ...
        <div class="container">
            ...
            <section>
                <div class="col-md-6 offset-md-3">
                    <h1>Editar region</h1>
                    <!-- mensaje de registro de la regiones -->
                    <?php if (isset($msg)) : ?>
            ...
            <?php endif; ?>
            <!-- lista de regiones que estan registrados -->
            <?php
            if ($region) : ?>
                <form action="" method="post">
                    <div class="form-group mb-3">
                        <label for="">Region <span class="text-danger">*</span></label>
                        <input type="text" name="nombre" value="<?php echo $region["nombre"]; ?>" class="form-control" placeholder="Ingrese el Nombre del Rol">
                    </div>
                    <div class="form-group mb-3">
