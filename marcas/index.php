...
//creamos la consulta a la tabla de marcas ordenado de manera ascendente para usar esos datos
$res = $mbd->query("SELECT id,nombre FROM marcas ORDER BY nombre");
$marcas = $res->fetchall(); //pido a PDO que disponibilice todo las marcas registradas

//print_r($marcas);exit;

?>
<?php if (isset($_SESSION['autenticado']) && $_SESSION['usuario_rol'] != 1 || 3) : ?>
                        ...
                        <tbody>
                            <?php foreach ($marcas as $marca) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="show.php?id=<?php echo $marca["id"]; ?>"><?php echo $marca["nombre"]; ?>
                                        </a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
